...
urlpatterns = [
    ...
    url(r'^player/delete', RemovePlayer.as_view(), name="remove_player"),
    url(r'^team/delete', RemoveTeam.as_view(), name="remove_team"),
    url(r'^arena/delete', RemoveArena.as_view(), name="remove_arena"),
    url(r'^match/delete', RemoveMatch.as_view(), name="remove_match"),
    url(r'^goal/delete', RemoveGoal.as_view(), name="remove_goal"),
    url(r'^foul/delete', RemoveFoul.as_view(), name="remove_foul"),
]
